...
#TODO: додати опис
define gui.about = _p("""
    Пориньте у світ альтернативного Миколаєва, де Ви вступите в університет, познайомитесь з різноманітними студентами і відчуєте себе першокурсником.\n
    {a=https://oliabekhter.github.io/codelove/}UwU production{/a} – команда майстрів створення візуальних новел. Адамчук Ван Ванич – майстер слова, тімлід і просто хороша людина. Захаренко Єлизавета Батьківна – людина з чарівним вмінням малювання. Даниленко Марія Батьківна – геній програмування. І остання, але не менш важлива, Бехтер Ольга Костянтинівна – шут виду бобових. Кожен учасник команди є незамінним, хоча кожний є майстром на всі руки.
""")
...
define config.save_directory = "Codelove-1665345422"
