...
label intro_cpp:
    ...
    "Ви точно не очікували побачити в кінці літа щось зимове, але це підняло Вам настрій і Ви вирішили купити як сувенір цю маленьку поробку, яка не вписувалась в навколишні обстановку, але тим і привернула Вашу увагу."
    ...
    "Задається, Ви встигнули. На перших сидіннях кожного ряду написано номер групи. Знайшовши свій, Ви просуваєтесь далі по ряду і сідаєте біля Ваших нових одногрупників."
