...
label intro_python:
    ...
    py "Тому і поспішають, що перерва велика, і можна в їдальні поїсти. Там же черга така, що за всі 40 хвилин можна й не встигнути поїсти."
