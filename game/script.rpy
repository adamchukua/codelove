...
label intro_ruby:
    ...
    "До дорозі до кабінету Ви скористалися можливістю і попитали Рубі щодо навчального процесу. Вона на все відповідала, навіть на, здавалось, дурні питання, і справила на Вас враження того старшокурсника, який все про все знає і готовий допомогти в будь-яку хвилину."
    ...
    "Через кілька годин всі почали потихенько розходитись і Ви вирішили йти додому. Попрощавшись зі всіма, Ви згадуєте усе, що сьогодні сталося і з нетерпінням чекаєте першого навчального дня."
