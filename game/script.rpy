...
label intro_ruby:
    ...
    "Нова інформація була лише про Вашу групу. Ви бігло познайомились з одногрупниками, після чого куратор ще раз звернув Вашу увагу на розклад і відпустила Вас до першого навчального дня."
...
label intro_python:
    ...
    "Ви заходите до аудиторії. Усередині вже достатньо багато людей, хоча Ви прийшли доволі рано. Майже всі студенти розбилися або по марам, або по невеличким групкам і не звертають на Вас уваги."
    ...
    "Пай щипнула Тона за руку. Здається, вони добре ладять. Ви хотіли ще щось запитати, але в цей момент аудиторія притихла - зайшов викладач."
...
label intro_java_and_js:
    ...
    "Ви розумієте, що це сама та людина, про яку Ви чули не досить гарні плітки, тому вирішуєте встати і пересісти за інший столик."
    ...
    if main_gender == 0:
        js "Правда ж, емм… Новенька?"
    elif main_gender == 1:
        js "Правда ж, емм… Новенький?"
    elif main_gender == 2:
        js "Правда ж, емм… Новенькі?"
